...
ALTER TABLE "alerts" ADD COLUMN "review_reason" text;--> statement-breakpoint
ALTER TABLE "audit_logs" ADD COLUMN "actor_id" uuid;--> statement-breakpoint
ALTER TABLE "audit_logs" ADD COLUMN "action" varchar(100) NOT NULL;--> statement-breakpoint
ALTER TABLE "audit_logs" ADD COLUMN "entity_type" varchar(50);--> statement-breakpoint
ALTER TABLE "audit_logs" ADD COLUMN "entity_id" varchar(100);--> statement-breakpoint
...
ALTER TABLE "incidents" ADD COLUMN "review_reason" text;--> statement-breakpoint

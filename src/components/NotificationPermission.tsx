          ...
          <div className="flex items-start gap-3 mt-1">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-sm tracking-tight text-red-400">
                {inIframe
                  ? "Iframe Preview Notification Limit"
                  : "Notifications Blocked"}
              </h3>
              <p className="text-zinc-400 mt-1 text-xs leading-relaxed">
                {inIframe ? (
                  <>
                    The Google AI Studio development sandbox restricts live
                    browser push notifications inside the embedded preview pane.
                    They will function normally when opened directly or
                    deployed.
                  </>
                ) : (
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-sm tracking-tight text-white">
              Enable Live SOS Alerts?
            </h3>
            <p className="text-zinc-400 mt-1 text-xs leading-relaxed">
              Receive alert notifications on active emergencies, firefighter
              updates, and official barangay security dispatches.
            </p>

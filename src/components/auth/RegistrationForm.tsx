    ...
    return (
      <div className="min-h-screen bg-brand-bg flex items-center justify-center p-6 text-center text-white relative h-screen overflow-hidden">
        ...
        <div className="max-w-md w-full animate-in fade-in zoom-in duration-500 relative z-10">
          ...
          <h2 className="text-3xl font-black mb-4 font-mono uppercase italic tracking-tighter shadow-glow-red">
          ...
          <div className="glass-panel p-8 rounded-3xl mb-8 border border-white/5">
            <p className="text-[10px] uppercase tracking-[0.3em] text-white/40 mb-2 font-black font-mono">
              REFERENCE PROTOCOL
            </p>
            <p className="text-xl font-mono font-black text-white italic tracking-tighter">
              {successId?.toUpperCase()}
            </p>
          </div>
          <button
    ...
    <div className="min-h-screen bg-brand-bg text-white p-6 md:p-12 font-sans overflow-x-hidden relative pb-20">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="flex items-center gap-6 mb-16">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tighter uppercase font-mono italic leading-none">
              Brgy. <span className="text-emergency">Tanod</span> S.O.S
            </h1>
            <p className="text-white/30 font-black uppercase text-[9px] tracking-[0.4em] mt-2 font-mono">
              Resident Enrollment Protocol • 5.0.0
            </p>
          </div>
          <button
            onClick={onCancel}
            className="ml-auto w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emergency/20 transition-all"
          >
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        <form
          ...
          className="glass-panel border-white/5 rounded-[48px] p-8 md:p-14 shadow-command animate-in slide-in-from-bottom-8 duration-700"
        >
          {step === 1 && (
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-white/30 ml-2 font-mono">
                    Full Name
                  </label>
                  <input
                    required
                    ...
                    className="w-full bg-brand-bg/50 border border-white/5 rounded-2xl p-5 focus:border-emergency/50 outline-none text-white font-bold font-mono placeholder-white/10 transition-all"
                  />
                </div>
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-white/30 ml-2 font-mono">
              ...
              <div className="pt-6">
                <button
                  type="button"
                  onClick={() => setStep(2)}
                  className="w-full md:w-auto px-16 py-5 bg-emergency text-white font-black italic rounded-2xl hover:scale-[1.02] active:scale-95 transition-all text-xs tracking-[0.3em] shadow-glow-red uppercase font-mono"
                >
                  NEXT PHASE
                </button>
              </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    required
                    placeholder="HOUSE NO., STREET, BARANGAY, LANDMARKS"
                    ...
                    className="w-full bg-brand-bg/50 border border-white/5 rounded-2xl p-5 min-h-24 focus:border-emergency/50 outline-none text-white font-bold font-mono placeholder-white/10 transition-all uppercase"
                  />
                </div>
              </div>
              <div className="flex gap-4 pt-6">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="flex-1 py-5 border border-white/10 font-black rounded-2xl hover:bg-white/5 transition-all uppercase tracking-widest font-mono text-xs"
                >
                  BACK
                </button>
                <button
                  type="button"
                  onClick={() => setStep(3)}
                  className="flex-1 py-5 bg-emergency text-white font-black rounded-2xl hover:scale-[1.02] active:scale-95 transition-all shadow-glow-red uppercase tracking-widest font-mono text-xs italic"
                >
                  NEXT PHASE
                </button>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <SelfieCamera
                onCapture={(dataUrl) => setSelfieDataUrl(dataUrl)}
              />
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input
                    required
                    placeholder="ASSIGN UNIQUE HANDLE"
              ...
              <div className="flex gap-4 pt-8">
                <button
                  type="button"
                  onClick={() => setStep(3)}
                  className="flex-1 py-5 border border-white/10 font-black rounded-2xl hover:bg-white/5 transition-all uppercase tracking-widest font-mono text-xs text-white/60"
                >
                  BACK
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-2 py-5 bg-emergency text-white font-black italic rounded-2xl hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 shadow-glow-red uppercase tracking-[0.2em] font-mono text-sm leading-none"
                >

...
export function SOSButtonPanel({ isSending, guardianMode, setGuardianMode, onInitiateSOS }: SOSButtonPanelProps) {
  return (
    <div className="relative max-w-2xl mx-auto mb-12">
      ...
      <div className="glass-panel border-white/10 rounded-[56px] p-8 md:p-12 relative overflow-hidden group shadow-[0_0_50px_rgba(0,0,0,0.5)] skew-card">
        <div className="absolute inset-0 tactical-grid opacity-10" />
        <div className="scanline opacity-20 pointer-events-none" />
        
        {/* Toggle Bar */}
        <div className="flex items-center justify-between mb-8 px-4 py-3 rounded-2xl bg-black/40 border border-white/10 backdrop-blur-md">
        ...
        {/* Footer Bar */}
        <div className="mt-8 flex items-center justify-center gap-4 bg-black/40 border border-white/5 rounded-full py-4 text-white/40">

...
export const GuardianButton: React.FC<GuardianButtonProps> = ({
  onInitiateSOS,
  guardianMode,
}) => {
  ...
  return (
    <div className="guardian-button-container">
      ...
      <div className="guardian-actions">
        <button onClick={toggleTestMode} className="test-mode-btn">
          {isTestMode ? "Exit Test Mode" : "Enable Test Mode"}
        </button>

        {buttonState === "activated" && (
          <button onClick={cancelSOS} className="cancel-sos-btn">
            CANCEL SOS
          </button>
        )}
      </div>

...
export function TanodLogo({
        ...
        {[...Array(15)].map((_, r) =>
          [...Array(15)].map((_, c) => (
            <path
              ...
              d={`M${c * 36 + (r % 2 ? 18 : 0)} ${
                r * 32
              } l18 0 l9 15 l-9 15 l-18 0 l-9 -15 z`}
              fill="none"
              stroke="#ef4444"
              strokeWidth="0.5"
            />
  ...
  return (
    ...
    >
      ...
      <path
        d="M200 30 L390 80 L390 300 C390 400 200 470 200 470 C200 470 10 400 10 300 L10 80 L200 30Z"
        fill="black"
        opacity="0.6"
        filter="blur(12px)"
      />
      ...
      <path
        d="M200 5 L390 60 L390 285 C390 390 200 455 200 455 C200 455 10 390 10 285 L10 60 L200 5Z"
        fill="#0f172a"
        stroke="#ffffff10"
        strokeWidth="2"
      />
      ...
      {/* Main Shield Body */}
      <path
        d="M200 10 L380 60 L380 280 C380 380 200 450 200 450 C200 450 20 380 20 280 L20 60 L200 10Z"
      ...
      <g transform="translate(200, 95)" opacity="0.9">
        ...
        <g fill="#f59e0b">
          <path
            d="M0 -75 l6 18 l20 0 l-16 12 l6 18 l-16 -12 l-16 12 l6 -18 l-16 -12 l20 0 z"
            transform="scale(0.3) translate(0, -20)"
          />
          <path
            d="M0 -75 l6 18 l20 0 l-16 12 l6 18 l-16 -12 l-16 12 l6 -18 l-16 -12 l20 0 z"
            transform="scale(0.3) translate(-120, 60) rotate(-30)"
          />
          <path
            d="M0 -75 l6 18 l20 0 l-16 12 l6 18 l-16 -12 l-16 12 l6 -18 l-16 -12 l20 0 z"
            transform="scale(0.3) translate(120, 60) rotate(30)"
      ...
      <g transform="translate(85, 385)">
        {/* Secure Shield */}
        <path
          d="M30 4 L55 12 L55 35 C55 50 30 60 30 60 C30 60 5 50 5 35 L5 12 Z"
          fill="#3b82f620"
          stroke="#3b82f6"
          strokeWidth="2"
        />
        <path
          d="M30 18 l4 10 l12 0-8 6 4 10-8-6-8 6 4-10-8-6 12 0z"
          fill="#3b82f6"
          transform="scale(0.4) translate(45, 45)"
        />

        {/* Transmission Tower */}
        <g transform="translate(100, 0)">
          <path
            d="M30 10 L15 55 L45 55 Z"
            stroke="#ef4444"
            strokeWidth="2.5"
            fill="none"
          />
...
export function TanodWordmark({
  ...
  return (
    <div
      className={cn("flex items-center", isSm ? "gap-2" : "gap-6", className)}
    ...
    >
      <div className="relative shrink-0">
        ...
        <div
          className={cn(
            "absolute -inset-2 bg-emergency/10 blur-2xl rounded-full -z-10",
            isSm ? "opacity-30" : "opacity-100"
          )}
        />
      </div>
      <div className="flex flex-col text-left min-w-0">
        <div className="flex items-center gap-2">
          <span
            className={cn(
              "font-mono font-black text-white/40 uppercase tracking-[0.2em]",
          ...
          <span
            className={cn(
              "px-1.5 py-0.5 rounded bg-brand-red font-black text-white uppercase tracking-[0.1em] shadow-glow-red",
              isSm ? "text-[7px]" : "text-[10px]"
            )}
          >
            S.O.S.
          </span>
        ...
        >
          TANOD
          <span className="text-brand-red group-hover:text-emergency transition-all duration-500 drop-shadow-[0_0_15px_rgba(239,68,68,0.5)]">
            NET
          </span>
        </h1>
        <div className="flex items-center gap-1.5 mt-1.5">
          ...
          <p
            className={cn(
              "font-mono text-white/30 uppercase tracking-[0.15em] font-black",
              isSm ? "text-[7px]" : "text-[10px]"
            )}
          >
            ACTIVE INTEL GRID
...
export function BackgroundPattern() {
  ...
  const hexagons = React.useMemo(() => {
    ...
    for (let row = 0; row < rows; row++) {
      for (let col = 0; col < cols; col++) {
        const x =
          col * HEX_SIZE * 1.73 + (row % 2 === 0 ? 0 : HEX_SIZE * 0.866);
        ...
        hexs.push({
          ...
          opacity,
          id: `${row}-${col}`,
          points: hexPoints(x, y, HEX_SIZE * 0.9),
        });
      }
    }
    return hexs;
  ...
  const horizontalLines = React.useMemo(
    () => [...Array(43)].map((_, i) => i * 20),
    []
  );
  const verticalLines = React.useMemo(
    () => [...Array(77)].map((_, i) => i * 20),
    []
  );
  ...
  return (
    ...
    >
      ...
      {/* BR */}
      <path
        d="M1500 840 L1500 800 L1460 800"
        fill="none"
        stroke="#ef4444"
        strokeWidth="1.5"
        opacity="0.25"
      ...
      {/* Circuit paths */}
      <path
        d="M0 200 L200 200 L220 220 L400 220 L420 200 L600 200"
        stroke="#ef4444"
        strokeWidth="0.8"
        opacity="0.06"
        fill="none"
      />
      <path
        d="M0 660 L180 660 L200 640 L380 640 L400 660 L560 660"
        stroke="#3b82f6"
        strokeWidth="0.8"
        opacity="0.06"
        fill="none"
      />
      <path
        d="M1100 0 L1100 160 L1120 180 L1120 320 L1100 340 L1100 500"
        stroke="#ef4444"
        strokeWidth="0.8"
        opacity="0.06"
        fill="none"
...
export function AppIcon({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center justify-center bg-[#0d0505] rounded-2xl border border-brand-red/20 overflow-hidden shadow-lg",
        className
      )}
      style={{ width: size, height: size }}
    >

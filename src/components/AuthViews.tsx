    ...
    <div className="min-h-screen bg-[#050508] flex flex-col items-center justify-center p-6 text-center relative overflow-hidden font-sans">
      ...
      >
        <div className="relative mb-10 group inline-block">
          ...
          <TanodLogo
            size={140}
            className="relative z-10 drop-shadow-[0_0_40px_rgba(255,75,75,0.25)] group-hover:drop-shadow-[0_0_60px_rgba(255,75,75,0.4)] transition-all duration-500"
          />
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <div
              className={cn(
                ...
                isSecure ? "bg-success" : "bg-emergency"
              )}
            />
            ...
            {!showEmailLogin ? (
              ...
              >
                <div className="flex items-center justify-between mb-4 px-2">
                  <span className="text-[9px] font-mono font-black text-white/20 uppercase tracking-widest italic">
                    Secure-Login
                  </span>
          ...
          <div className="pt-8 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[8px] font-mono text-white/15 uppercase tracking-[0.5em] font-black italic">
                Network Ops
              </span>
              <div className="h-[1px] flex-1 bg-white/5" />
            </div>
            ...
            <div className="border border-emergency/20 bg-emergency/5 p-4 rounded-[20px] text-center">
              <span className="text-[10px] font-mono font-black text-emergency uppercase tracking-[0.2em] block mb-2">
                IFRAME LIMITATION DETECTED
              </span>
              <p className="text-[9px] text-white/50 leading-relaxed font-mono uppercase tracking-widest">
                Google Login is blocked inside the preview window.
                <br />
                <br />
                Please click the{" "}
                <span className="text-white">"OPEN IN NEW TAB"</span> button at
                the <strong className="text-white">TOP RIGHT CORNER</strong> of
                the AI Studio screen to access the app natively.
              </p>
            </div>
    ...
    <button
      ...
      className={cn(
        ...
        disabled
          ...
          : "hover:bg-white/[0.05] hover:border-white/20 hover:-translate-y-2 active:scale-95"
      )}
    >
      <div
        className={cn(
      ...
      <div
        className={cn(
          ...
          isEmergency
            ? "bg-emergency/10 border border-emergency/20 text-emergency group-hover:bg-emergency group-hover:text-white"
            : isInfo
            ? "bg-info/10 border border-info/20 text-info group-hover:bg-info group-hover:text-white"
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-2">
          <h3 className="text-3xl font-black text-white italic tracking-tighter font-mono uppercase leading-none">
            {title}
          </h3>
          <div
            className={cn(
        ...
        <p className="text-white/40 text-[13px] leading-relaxed font-bold uppercase tracking-tight font-mono group-hover:text-white/60 transition-colors">
          {desc}
        </p>
      </div>

      <div className="mt-12 flex items-center gap-2 relative z-10">
        <span className="text-[10px] font-mono font-black text-white/5 group-hover:text-white/40 transition-colors uppercase tracking-[0.3em]">
          Select Profile
        </span>
    ...
    <div className="min-h-screen bg-[#050508] flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      <div className="glass-panel border-white/5 p-12 rounded-[56px] w-full max-w-md mb-12 relative overflow-hidden backdrop-blur-2xl bg-white/[0.02]">
        ...
        <p className="text-white/40 text-[13px] leading-relaxed font-mono uppercase tracking-widest">
          ...
          <span className="text-white font-black italic">{user.name}</span> is
          currently under{" "}
          <span className="text-caution font-black">
        ...
        <div className="mt-12 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-[9px] font-black uppercase text-white/40 tracking-[0.6em] font-mono">
              Verifying Node Encryption...
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#050508] flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      <div className="glass-panel border-emergency/20 p-12 rounded-[56px] w-full max-w-md mb-12 shadow-[0_0_60px_rgba(255,75,75,0.1)] relative overflow-hidden bg-black/40 backdrop-blur-3xl">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <p className="text-[10px] font-black uppercase text-emergency tracking-[0.4em] font-mono leading-none">
            Security Briefing
          </p>
          <AlertTriangle className="w-4 h-4 text-emergency" />
        </div>

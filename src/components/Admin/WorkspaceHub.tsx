    ...
    return (
      <TacticalCard className="p-8 border-white/5 bg-white/5">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div>
            <h3 className="text-xl font-black italic tracking-tighter uppercase font-mono text-white">
              Google Workspace Link Required
            </h3>
            <p className="text-[10px] font-bold text-white/30 uppercase tracking-widest mt-2 px-12 leading-relaxed">
              Connect Google Chat and Calendar to mirror alerts and incident
              logs for professional command oversight
            </p>
          </div>
          <button
      ...
      <div className="px-8 py-5 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-tactical-cyan/10 flex items-center justify-center border border-tactical-cyan/30">
            <RefreshCw
              className={cn(
                "w-5 h-5 text-tactical-cyan",
                isLoading && "animate-spin"
              )}
            />
          </div>
          <div>
            <h3 className="text-sm font-black italic tracking-tighter uppercase font-mono text-white">
              Workspace HUB
            </h3>
                  ...
                  {selectedSpace && (
                    <div className="p-4 rounded-2xl bg-success/5 border border-success/20 flex items-center gap-3">
                      ...
                      <span className="text-[9px] font-bold text-success/60 uppercase tracking-widest">
                        SOS Alerts will be mirrored here
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {selectedTaskList && (
                    <div className="p-4 rounded-2xl bg-info/5 border border-info/20 flex items-center gap-3">
                      ...
                      <span className="text-[9px] font-bold text-info/60 uppercase tracking-widest">
                        High-priority tasks will sync here
                      </span>
                    </div>
                  )}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/10">
                    <div>
                      <p className="text-[10px] font-black text-white italic tracking-tighter uppercase">
                        Incident Auto-Logging
                      </p>
                      <p className="text-[8px] text-white/40 uppercase tracking-widest mt-1">
                        Mirror reports to Calendar
                      </p>
                    </div>
                    <button
                  ...
                  <div className="space-y-2">
                    ...
                    {events.length > 0 ? (
                      events.map((e) => (
                        ...
                        >
                          <span className="text-[9px] text-white/60 truncate max-w-[150px] font-mono uppercase">
                            {e.summary}
                          </span>

...
const INITIAL_INTEGRATIONS: Integration[] = [
  {
    ...
    description:
      "Decompress compressed cellular alerts (<140 chars) received over-the-air from remote offline Tanods.",
    icon: Radio,
    status: "connected",
  ...
  },
  {
    ...
    description:
      "Lightweight automated web monitoring for local news and barangay announcements.",
    icon: Bot,
    status: "connected",
    lastSync: "2 mins ago",
  ...
  },
  {
    ...
    description:
      "Event-driven auto-remediation and dispatch workflows for critical SOS triggers.",
    icon: Zap,
    status: "connected",
    lastSync: "Just now",
    color: "text-amber-400 bg-amber-400/10 border-amber-400/20",
  },
  {
    ...
    description:
      "Auto-dispatch SMS alert failovers to nearby Tanods during unassigned or offline-recovered emergencies.",
    icon: PhoneCall,
    status: "disconnected",
  ...
  },
  {
    ...
    name: "FMD Server",
    description:
      "Find My Device server to track all issued Tanod radios and smartphones.",
    icon: Search,
    status: "disconnected",
  ...
  },
  {
    ...
    name: "Node-RED IoT",
    description:
      "Wiring flood sensors and fire alarms via MQTT into the Barangay Command Center.",
    icon: Workflow,
    status: "connected",
  ...
  },
  {
    ...
    description:
      "Isochrone map generation and real-time navigation directions for Tanod Responders.",
    icon: MapIcon,
    status: "connected",
    lastSync: "5 mins ago",
  ...
  },
  {
    ...
    name: "Open-Meteo",
    description:
      "Weather forecasting and climate data integration for flooding and typhoon alerts.",
    icon: CloudRain,
    status: "connected",
    lastSync: "1 hour ago",
  ...
  },
  {
    ...
    description:
      "Evaluate Guardian AI LLM responses to assure high accuracy during emergencies.",
    icon: Terminal,
    status: "disconnected",
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 z-10 w-full">
        <div>
          ...
          <p className="text-sm font-mono text-white/40 mt-1 uppercase tracking-widest max-w-2xl leading-relaxed">
            Manage third-party microservices, IoT nodes, routing engines, and
            automation frameworks directly hooked into the Tactical Grid.
          </p>
        </div>
      </div>
            ...
            {activeConfig === "twilio" ? (
              ...
              <>
                ...
                <p className="text-xs text-white/50 mb-6">
                  Enter connection endpoints or access tokens.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0F1115] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:border-emergency outline-none font-mono"
                    />
                  </div>
                  <div>
                    <label className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1.5 block">
                ...
                <div className="flex gap-3 mt-8">
                  ...
                  <button
                    ...
                    className="flex-1 py-3 bg-emergency hover:bg-emergency/90 text-white shadow-[0_0_15px_rgba(239,68,68,0.3)] rounded-xl text-sm font-bold transition-all"
                  >
                    Save Settings
                  </button>
                </div>

...
export default function ResidentTacticalMap({
    ...
    const loadResidents = async () => {
      ...
      try {
        ...
        const formatted = data
          ...
          .filter(
            (r: any) =>
              r.status === "approved" && isValidCoord(r.gpsLat, r.gpsLng)
          );
  ...
  const filteredResidents = residents.filter((r) => {
    ...
    if (specialNeedsFilter !== "all") {
      if (specialNeedsFilter === "yes" && r.specialNeeds !== "Yes")
        return false;
    ...
    <div className="flex flex-col h-full space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 glass-panel p-8 rounded-[40px] border-white/5 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[10px] font-mono text-white/30 uppercase tracking-[0.3em] mt-2">
            Geospatial Distribution of Approved Community Members
          </p>
        </div>
        ...
        {loading ? (
          <div className="absolute inset-0 z-20 flex items-center justify-center bg-brand-bg/50 backdrop-blur-md">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-[10px] font-black text-white/40 uppercase font-mono tracking-[0.4em] animate-pulse">
                  ...
                  <div className="p-4 bg-[#0D0D12] text-white font-mono min-w-[240px] rounded-2xl border-2 border-white/10 shadow-2xl">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-[8px] bg-white/5 text-white/40 px-1.5 py-0.5 rounded border border-white/10">
                            ID: {resident.idNumber}
                          </span>
                          <span
                            className={cn(
                              "text-[8px] px-1.5 py-0.5 rounded border font-black uppercase",
                              resident.specialNeeds === "Yes"
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center gap-3 p-2.5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all group">
                        ...
                        <div>
                          <p className="text-[7px] text-white/30 uppercase font-bold tracking-widest leading-none mb-1">
                            Tactical Comms
                          </p>
                      ...
                      <div className="flex items-center gap-3 p-2.5 rounded-xl bg-white/5 border border-white/5">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] font-black truncate max-w-[150px]">
                    ...
                    <button
                      ...
                      onClick={() =>
                        window.open(
                          `https://www.google.com/maps?q=${resident.gpsLat},${resident.gpsLng}`,
                          "_blank"
                        )
                      }
                    >
                      <ExternalLink className="w-3 h-3" /> Execute Route
                      Extraction
                    </button>
                  </div>
                </Popup>

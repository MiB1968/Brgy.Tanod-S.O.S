...
export function DashboardHeader({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row md:justify-between items-start md:items-end gap-6 mb-10 relative glass-panel p-6 sm:p-8 rounded-[32px] sm:rounded-[48px] border-white/10 skew-card shadow-2xl"
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-start gap-4">
        <div className="flex items-center justify-between w-full gap-2 min-h-8">
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <span className="text-[8px] sm:text-[10px] font-mono text-emergency font-black uppercase tracking-[0.1rem] sm:tracking-[0.4em] whitespace-nowrap">
              Signal: Secure Encryption Active
            </span>
          </div>
          <GuardianAILoader />
        </div>
        <h2 className="text-2xl sm:text-4xl md:text-6xl font-black italic tracking-tighter uppercase text-white font-mono leading-none flex items-center flex-wrap gap-2 sm:gap-4 outline-text">
          <TanodLogo
            size={40}
            animated={true}
            className="sm:w-16 sm:h-16 text-emergency shadow-glow-red shrink-0"
          />
          <div className="flex flex-col">
            <span className="flex items-center">
              COMMAND<span className="text-emergency">CENTER</span>
            </span>
            <span className="text-[8px] sm:text-[10px] font-black tracking-[0.3em] sm:tracking-[0.5em] text-white/20 -mt-0.5 sm:-mt-1 ml-0.5 sm:ml-1">
              ADMIN_PANEL_v2
            </span>
          </div>
        </h2>
              ...
              {[
                {
                  ...
                  label: "Super",
                  icon: Shield,
                  activeClass: "bg-red-500/15 text-red-400 border-red-500/35",
              ...
              [
                {
                  ...
                  icon: Monitor,
                  label: "SOLO",
                  title: "Focus Monitor (1 Panel)",
                },
                {
                  key: "standard",
                  icon: Columns,
                  label: "DUAL",
                  title: "Strategic Split (2 Panels)",
                },
                {
                  key: "panoramic",
                  icon: LayoutGrid,
                  label: "PANORAMIC",
                  title: "Panoramic Command (3 Panels)",
                },
              ] as const
            ).map((item) => {
        ...
        <p className="text-[8px] sm:text-[10px] font-mono text-white/40 uppercase tracking-[0.2em] sm:tracking-[0.4em] mt-2 bg-white/5 inline-block px-4 py-1.5 rounded-full border border-white/5">
      ...
      <div className="flex flex-row items-center gap-2 sm:gap-3 relative z-10 w-full md:w-auto mt-4 md:mt-0 flex-wrap">
        ...
        >
          ...
          <span className="text-[9px] sm:text-[11px] font-black text-cyan-200 uppercase tracking-widest font-mono">
            WebLLM Map
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-[9px] sm:text-[11px] font-black text-white/50 group-hover:text-white uppercase tracking-widest font-mono">
            MISSION
          </span>
        </button>

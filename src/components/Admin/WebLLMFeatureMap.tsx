...
const ALL_FEATURES = [
  ...
  // ── RESIDENT (NEW) ─────────────────────────────────────────────────────────
  {
    ...
    example:
      "MEDICAL SOS, no network → 'Huwag ilipat. Itaas ang binti. Pigilan ang dugo...'",
  },
  {
    id: 3,
    status: "EASY",
  ...
  },
  {
    ...
    example:
      "'Nakatira ako sa 45 Rizal Street, Purok 2' → address, street, purok auto-filled",
  },
  {
    id: 5,
    status: "EASY",
    ...
    example:
      "'responding' → 'Ang inyong ulat ay kasalukuyang sinasagot ni Tanod Juan. Inaasahang darating sa loob ng 10 minuto.'",
  },
  {
    id: 6,
    status: "EASY",
    ...
    example:
      "'Paano mag-report ng nawawalang bata?' → step-by-step guide in Tagalog",
  },
  ...
  // ── TANOD (NEW) ────────────────────────────────────────────────────────────
  {
    ...
    example:
      "'away, 3 lalaki, pinahiwalay' → 'Sa ika-3 ng hapon, tatlong lalaki ang nakipagtalo...'",
  },
  {
    id: 8,
    status: "EASY",
    ...
    example:
      "'may dala siyang kutsilyo' → Severity 5→9, banner: '⚠️ WEAPON DETECTED'",
  },
  {
    id: 9,
    status: "MEDIUM",
    ...
    example:
      "'3 incidents, 1 unresolved in Purok 3, resident Juan still nervous. Recommend check-in.'",
  },
  {
    id: 10,
    status: "MEDIUM",
    ...
    example:
      "'Purok 3 ay may 4 insidente. Inirekomenda: patrol tuwing 9PM-12MN sa Rizal St.'",
  },
  {
    id: 11,
    status: "MEDIUM",
    ...
    example:
      "Captain: 'Simulate a FIRE at Purok 4' → WebLLM: 'May sunog! Tulungan niyo kami!'",
  },
  {
    id: 12,
    status: "EASY",
    ...
    example:
      "3 witness statements → 'Lahat ay nagpapatunay ng away. 2 of 3 say weapon present. Contradiction on suspect description.'",
  },
  ...
  // ── ADMIN (NEW) ────────────────────────────────────────────────────────────
  {
    ...
    example:
      "'Sa nakalipas na linggo, 12 ulat ang natanggap: 4 sunog, 3 krimen...'",
  },
  {
    id: 14,
    status: "EASY",
    ...
    example:
      "riskScore: 87 → 'Ang admin na ito ay nagpadala ng 15 utos sa loob ng 20 minuto sa gabi. Posibleng kompromiso.'",
  },
  {
    id: 15,
    status: "EASY",
    ...
    example:
      "FIRE, severity 8 → 'PANSIN: May nasusunog sa Purok 4. Mangyaring lumayo at...'",
  },
  {
    id: 16,
    status: "MEDIUM",
    ...
    example:
      "'Sunog sa simbahan' + 'Apoy sa kanto ng simbahan' → ⚠️ Likely same incident",
  },
  {
    id: 17,
    status: "EASY",
    ...
    example:
      "'Lahat ng sunog sa Purok 3 noong Enero' → instant filtered + summarized results",
  },
  {
    id: 18,
    status: "MEDIUM",
    ...
    example:
      "'3 fights on Rizal St every Friday night. Possible connection to nearby drinking spot.'",
  },
  {
    id: 19,
    status: "EASY",
    ...
    example:
      "Two residents with same address and phone → '⚠️ Possible duplicate registration. Verify identity.'",
  },
  {
    id: 20,
    status: "MEDIUM",
    ...
    example:
      "'2 aktibong insidente. Pinaka-urgent: sunog sa Purok 4. Pinakamalapit na Tanod: 400m ang layo.'",
  },
  ...
  // ── SYSTEM (NEW) ───────────────────────────────────────────────────────────
  {
    ...
    example:
      "'SOS rcvd fr Purok3 re fire' → 'Natanggap ang SOS mula sa Purok Tatlo. May nasusunog.'",
  },
  {
    id: 22,
    status: "MEDIUM",
    ...
    example:
      "WebLLM asks: 'Anong pangalan ng inyong barangay captain?' → Admin answers → verified",
  },
  {
    id: 23,
    status: "EASY",
    ...
    example:
      "Chat messages become shorter + capital letters → 'Resident distress level HIGH. Expedite response.'",
  },
  {
    id: 24,
    status: "MEDIUM",
    ...
    example:
      "Incident data → Full printed blotter: 'Ito ay nagpapatunay na noong ika-18 ng Mayo...'",
  },
];
...
export function WebLLMFeatureMap() {
  ...
  const filtered = ALL_FEATURES.filter(
    (f) => tier === "ALL" || f.tier === tier
    ...
    >
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        >
          ...
          >
            WebLLM Intelligence Map — Complete
          </span>
        </div>
        <h1
          style={{
        ...
        <p style={{ fontSize: 11, color: "#ffffff50", margin: "4px 0 0" }}>
          24 features · 1 model download · zero API cost per run
        </p>
      </div>
            ...
            return (
              <div key={t}>
                ...
                >
                  ...
                  <div
                    style={{ flex: 1, height: 1, background: "#ffffff08" }}
                  />
                </div>
                <div
                  style={{
                      ...
                      >
                        ...
                        >
                          <span
                            style={{
                              fontSize: 9,
                              color: f.offline ? "#10b981" : "#ffffff30",
                            }}
                          >
                            {f.offline ? "✅" : "❌"} offline
                          </span>
                          <span
                            style={{
                              fontSize: 9,
                              color: f.savesCost ? "#f59e0b" : "#ffffff30",
                            }}
                          >
        ...
        >
          ...
          >
            <div>
              ...
              <p
                style={{ margin: "4px 0 0", fontSize: 11, color: "#ffffff50" }}
              >
                {sel.tagalog}
              </p>
            </div>
          ...
          >
            {[
              ["Impact", sel.impact, "#ef4444"],
              ["Effort (low=easy)", sel.effort, "#3b82f6"],
            ].map(([label, val, color]) => (
              <div
                key={label as string}
                style={{

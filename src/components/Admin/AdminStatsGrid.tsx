...
function StatCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "p-4 rounded-2xl inline-flex mb-6 transition-all group-hover:scale-110 shadow-2xl relative z-10",
          bg,
          color,
          pulse && "animate-pulse shadow-[0_0_15px_var(--color-tactical-red)]"
        )}
      >
        <Icon className="w-6 h-6" glow={pulse} />
      </div>
      <div className="relative z-10">
        <h4 className="text-[9px] font-black uppercase text-white/40 tracking-[0.4em] mb-2 font-mono">
          {label}
        </h4>
        <p className="text-4xl font-black text-white italic tracking-tighter font-display leading-none">
          {value}
        </p>
      </div>
    </TacticalCard>

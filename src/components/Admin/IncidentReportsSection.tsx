      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {recentIncidents.length === 0 ? (
          <div className="col-span-full py-12 text-center glass-panel rounded-[32px] border-white/5">
            <p className="text-white/20 font-black uppercase text-[10px] tracking-widest font-mono italic">
              No archived intelligence reports found.
            </p>
          </div>
        ) : (
          recentIncidents.slice(0, 6).map((incident, index) => (
            ...
            >
              ...
              <h5 className="text-sm font-bold text-white mb-2 italic tracking-tight font-mono">
                {incident.location}
              </h5>
